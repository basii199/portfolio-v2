            ...
            >          
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-gray-50/30 dark:bg-gray-900/90 border border-gray-200 dark:border-gray-800 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#1e8fff50] placeholder:text-gray-300 dark:placeholder:text-gray-500"
              ...
              <div>
                ...
                <textarea
                  ...
                  name="message"
                  rows={5}
                  className="resize-none w-full px-4 py-3 bg-gray-50/30 dark:bg-gray-900/90 border border-gray-200 dark:border-gray-800 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#1e8fff50] placeholder:text-gray-300 dark:placeholder:text-gray-500"
